...
b) Modifizieren Sie den Code in `slow-sim.R` so, dass er i) **mindestens 4x schneller** läuft (ohne dass sich die Ergebnisse qualitativ ändern!!) und ii) unseren Vorstellungen von sauber dokumentierter, gut strukturierter und defensiv programmierter Software entspricht.
